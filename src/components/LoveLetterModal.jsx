...
export default function LoveLetterModal({ isOpen, onClose, letter }) {
  ...
  return (
    ...
    >
      <div
        data-love-card
        className="relative w-full max-h-[85vh] overflow-visible animate-fade-in"
      >
        {/* Floating Close Button - Styled EXACTLY like the music toggle button, kept outside the scroll container so it never scrolls! */}
        <motion.button
          type="button"
          onClick={onClose}
          whileHover={{ 
        ...
        >
          <FiX size={22} style={{ display: "flex" }} />
        </motion.button>
